...
public class OcUserRequestBean {
    ...
    private boolean idDupFlg;
    private String ocErrMsg;
    ...
    public boolean isIdDupFlg() {
        return idDupFlg;
    }

    public String getOcErrMsg() {
        return ocErrMsg;
    }

    public void setOcErrMsg(String ocErrMsg) {
        this.ocErrMsg = ocErrMsg;
    }
